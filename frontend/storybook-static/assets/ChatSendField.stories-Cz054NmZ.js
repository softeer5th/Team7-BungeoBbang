    ...
    const T = (s) => {
      ...
      v = () => {
        ...
        const s = Math.round(-p / window.innerWidth),
          d = Math.max(0, Math.min(i - 1, s));
        l == null || l(d), T(-d * window.innerWidth);
      };
    return e.jsxs(Ce, {
      children: [
        e.jsxs(be, {
    ...
    (
      {
        ...
        sendButtonDisabledBackgroundColor: F = "#E0E0E0",
        sendButtonIconColor: f = "#FFFFFF",
        sendButtonDisabledIconColor: C = "#F4F4F4",
        imageButtonBackgroundColor: T = "#E0E0E0",
        imageButtonDisabledBackgroundColor: V = "#E0E0E0",
        imageButtonIconColor: b = "#8D8D8D",
        imageButtonDisabledIconColor: v = "#F4F4F4",
      ...
      const de = (n) => {
          let h = n;
          n.length >= i && (h = n.slice(0, i)), k(h), ee(h);
        },
        R = () => {
          if (w.current) {
            w.current.style.height = "auto";
            let n = w.current.scrollHeight;
            n >= S && (n = S), (w.current.style.height = n + "px");
          }
        },
        Z = () => {
          E || ((y.trim() || c) && (te(y, g), k("")));
...
`,
  ...
  border: ${(t) => {
    var r, i;
    return `${((r = t.border) == null ? void 0 : r.borderWidth) || "1px"} solid ${((i = t.border) == null ? void 0 : i.borderColor) || "#E0E0E0"}`;
  }};
  border-radius: ${(t) => {
    var r;
...
const { useArgs: Y } = __STORYBOOK_MODULE_PREVIEW_API__,
  ...
  B = {
    ...
    render: function (r) {
      ...
      return e.jsx(M, { ...r, initialText: i, onChange: m });
    },
  },
  I = {
    args: {
    ...
    render: function (r) {
      const [{ value: i }, l] = Y(),
        ...
        p = (u) => {
          const x = A.filter((F, f) => f !== u);
          l({ ...r, images: x });
        };
      return e.jsx(M, { ...r, initialText: i, onChange: m, onImageDelete: p });
    },
  },
  j = {
    args: {
...
B.parameters = {
  ...
  render: function Render(args) {
    ...
    return <ChatSendField {...args} initialText={value} onChange={handleTextChange} />;
      ...
      ...(($ = (_ = B.parameters) == null ? void 0 : _.docs) == null
        ? void 0
        : $.source),
    },
  },
...
I.parameters = {
  ...
  render: function Render(args) {
    ...
    return <ChatSendField {...args} initialText={value} onChange={handleTextChange} onImageDelete={handleImageDelete} />;
      ...
      ...((U = (O = I.parameters) == null ? void 0 : O.docs) == null
        ? void 0
        : U.source),
    },
  },
