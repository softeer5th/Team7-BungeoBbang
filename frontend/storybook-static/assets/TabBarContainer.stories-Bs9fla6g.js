import { j as a } from "./jsx-runtime-C8_8iAox.js";
import { d as C } from "./Typography-BU4bE9sX.js";
import { r as l } from "./index-Dkaqzkgy.js";
import { T as _ } from "./TabBar-ssvqXT5D.js";
const g = ({
    tabItems: t,
    currentTabSelectedIndex: s,
    contentBackgroundColor: i = "#F4F4F4",
    tabBarBackgroundColor: u = "#FFFFFF",
    selectedTabBarItembackgroundColor: m = "#FFFFFF",
    indicatorColor: c = "#1F87FF",
    tabBarTextColor: F = "#C6C6C6",
    tabBarSelectedTextColor: p = "#1F87FF",
    onTabItemClick: k = () => {},
    contents: S,
  }) => {
    const [I, b] = l.useState(s || 0),
      r = l.useRef(null),
      [v, w] = l.useState(0),
      R = (e) => {
        if (r.current) {
          e.stopPropagation();
          const n = r.current.offsetWidth,
      ...
      A = (e) => {
        const n = t.findIndex((o) => o.itemId === e);
        b(n), f(n), k(e);
      },
      f = (e) => {
        var n, o;
        if (r.current) {
          const T = (n = r.current) == null ? void 0 : n.scrollLeft,
            E = (o = r.current) == null ? void 0 : o.offsetWidth;
          w(T + -e * E), sessionStorage.setItem("activeTabIndex", String(e));
        }
      };
    return (
      l.useEffect(() => {
      ...
      l.useEffect(() => {
        const e = s ?? (t[0].itemId || 0);
        b(e), f(e);
      }, [s]),
      a.jsxs(a.Fragment, {
        children: [
          a.jsx(_, {
            currentDestination: t[I].itemId,
            items: t,
            onItemClick: A,
            backgroundColor: u,
            selectedItembackgroundColor: m,
            indicatorColor: c,
            textColor: F,
            selectedTextColor: p,
          }),
          a.jsx(q, {
            ...
            onScroll: R,
            children: t.map((e, n) =>
              a.jsx(j, { transX: v, children: S(n) }, e.itemId),
            ),
          }),
        ],
      })
...
@example 0`,
    ...
    contentBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `컨텐츠 영역의 배경 색상 (선택 사항)
@default "#F4F4F4"
@example "#FFFFFF"`,
...
@example "#F8F9FA"`,
    ...
    selectedTabBarItembackgroundColor: {
      required: !1,
      tsType: { name: "string" },
...
const { useArgs: V } = __STORYBOOK_MODULE_PREVIEW_API__,
  ...
  d = {
    args: { currentTabSelectedIndex: 1 },
    render: function (s) {
      const [{ currentTabSelectedIndex: i }, u] = V(),
        m = (c) => {
          const F = x.findIndex((p) => p.itemId === c);
          u({ currentTabSelectedIndex: F });
        };
      return a.jsx(g, {
        ...s,
        tabItems: x,
        currentTabSelectedIndex: i,
        onTabItemClick: m,
        contents: (c) =>
          a.jsxs(D, { children: ["📌 현재 선택된 탭: ", x[c].title] }),
      });
    },
  },
  D = C.div`
...
d.parameters = {
  ...
  render: function Render(args) {
    ...
    return <TabBarContainer {...args} tabItems={sampleTabItems} currentTabSelectedIndex={currentTabSelectedIndex} onTabItemClick={handleTabChange} contents={(index: number) => <TabContent>📌 현재 선택된 탭: {sampleTabItems[index].title}</TabContent>} />;
      ...
      ...((y = (h = d.parameters) == null ? void 0 : h.docs) == null
        ? void 0
        : y.source),
    },
  },
};
const W = ["TabBarContainerDefault"];
export { d as TabBarContainerDefault, W as __namedExportsOrder, N as default };
