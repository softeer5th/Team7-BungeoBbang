...
import { d as r, T as l } from "./Typography-BU4bE9sX.js";
import { r as B } from "./index-Dkaqzkgy.js";
import { m as p } from "./proxy-DSREAjDx.js";
const N = r(p.div)`
    ...
    (
      {
        ...
        receiverName: m,
        receiverIconSrc: d,
        receiverIconBackgroundColor: j = "#FFEFB3",
        message: k,
        timeText: w,
        images: u,
        nameTextColor: R = "#393939",
        backgroundColor: I = "#F4F4F4",
        textColor: q = "#393939",
        ...
        children: [
          e.jsx(p.div, {
            ...
            children: e.jsxs(S, {
              children: [
                m &&
                  e.jsx(V, { variant: "body2", nameTextColor: R, children: m }),
                d &&
                  e.jsx(W, {
                    backgroundColor: j,
                    children: e.jsx("img", {
...
@example "chat_12345"`,
    ...
    receiverName: {
      required: !1,
      tsType: { name: "string" },
      description: `메시지를 보낸 사람의 이름 (선택 사항)
@example "총학생회"`,
    },
    receiverIconSrc: {
      required: !1,
      tsType: { name: "string" },
      description: `수신자의 아이콘 이미지 URL (선택 사항)
@example "https://example.com/icon.png"`,
    },
    receiverIconBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `수신자의 아이콘 배경 색상 (선택 사항)
@example "#FFE0F7"`,
...
@example "오후 01:20"`,
    ...
    nameTextColor: {
      required: !1,
      tsType: { name: "string" },
      description: `수신자 이름의 텍스트 색상 (선택 사항)
@example "#1F87FF"`,
...
총학생회 드림\`,
    ...
    timeTextColor: '#C6C6C6'
      ...
      ...((C = (g = a.parameters) == null ? void 0 : g.docs) == null
        ? void 0
        : C.source),
    },
  },
...
총학생회 드림\`,
    ...
    timeTextColor: '#C6C6C6'
      ...
      ...((F = (f = s.parameters) == null ? void 0 : f.docs) == null
        ? void 0
        : F.source),
    },
  },
...
n.parameters = {
  ...
  총학생회 드림\`,
    ...
    timeTextColor: '#C6C6C6'
      ...
      ...((T = (y = n.parameters) == null ? void 0 : y.docs) == null
        ? void 0
        : T.source),
    },
  },
};
const P = ["ReceiverDefault", "ReceiverWithImage", "ReceiverWithIcon"];
export {
  a as ReceiverDefault,
