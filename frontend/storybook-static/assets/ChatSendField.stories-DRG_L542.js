...
import { r as o } from "./index-Dkaqzkgy.js";
import { T as q, d as a } from "./Typography-BU4bE9sX.js";
import { S as me } from "./arrow-left-RKZ4lgrs.js";
import { a as fe } from "./getBorderType-XRkN7lgl.js";
import "./BorderProps-BeEA2FI6.js";
const he = (t) =>
    o.createElement(
      "svg",
      {
  ...
  N = ({
    ...
    const [p, u] = o.useState(-r * window.innerWidth),
      [x, C] = o.useState(!1),
      f = o.useRef(null),
      b = o.useRef(null);
    o.useEffect(() => {
    ...
    const T = (s) => {
        u((d) => d + (s - d) * 0.1),
          (b.current = requestAnimationFrame(() => T(s)));
      },
      V = (s) => {
        C(!0),
          (f.current = "touches" in s ? s.touches[0].clientX : s.clientX),
          cancelAnimationFrame(b.current);
      },
      v = (s) => {
        if (!x) return;
        const d = "touches" in s ? s.touches[0].clientX : s.clientX;
        u(-r * window.innerWidth + (d - (f.current || 0)));
      },
      y = () => {
        C(!1);
        const s = Math.round(-p / window.innerWidth),
          d = Math.max(0, Math.min(l - 1, s));
        i == null || i(d), T(-d * window.innerWidth);
      };
    return e.jsxs(Ce, {
      children: [
        e.jsxs(be, {
        ...
        e.jsx(we, {
          ...
          children: e.jsx(Ee, {
            style: {
              ...
              transition: x ? "none" : "transform 0.3s ease-out",
            },
            children: m.map((s, d) =>
              e.jsx(
                Te,
...
N.__docgenInfo = {
  ...
  props: {
    ...
    currentIndex: { required: !0, tsType: { name: "number" }, description: "" },
    totalImages: { required: !0, tsType: { name: "number" }, description: "" },
    onChangeImage: {
      required: !1,
      tsType: {
        name: "signature",
        type: "function",
        raw: "(newIndex: number) => void",
        signature: {
          arguments: [{ type: { name: "number" }, name: "newIndex" }],
          return: { name: "void" },
        },
      },
      description: "",
    ...
    (
      {
        ...
        disabledPlaceHolder: r = "텍스트를 입력할 수 없습니다.",
        maxLength: l = 500,
        initialText: i = "",
        backgroundColor: m = "#FFFFFF",
        textFieldBackgroundColor: p = "#FFFFFF",
        textFieldDisabledBackgroundColor: u = "#F4F4F4",
        sendButtonBackgroundColor: x = "#1F87FF",
        sendButtonDisabledBackgroundColor: C = "#E0E0E0",
        sendButtonIconColor: f = "#FFFFFF",
        sendButtonDisabledIconColor: b = "#F4F4F4",
        imageButtonBackgroundColor: T = "#E0E0E0",
        imageButtonDisabledBackgroundColor: V = "#E0E0E0",
        imageButtonIconColor: v = "#8D8D8D",
        imageButtonDisabledIconColor: y = "#F4F4F4",
        placeholderColor: s = "#1F87FF",
        disabledPlaceholderColor: d = "#C6C6C6",
        textColor: G = "#262626",
        disabledTextColor: J = "#C6C6C6",
        textFieldBorder: Q = {
          ...fe(),
          borderWidth: "1px",
          borderColor: "#E0E0E0",
      ...
      const de = (n) => {
          let h = n;
          n.length >= l && (h = n.slice(0, l)), k(h), ee(h);
        },
        R = () => {
          if (E.current) {
            E.current.style.height = "auto";
            let n = E.current.scrollHeight;
            n >= S && (n = S), (E.current.style.height = n + "px");
          }
        },
        Z = () => {
          w || ((F.trim() || c) && (te(F, g), k("")));
        ...
        ce = (n) => {
          n.target.files &&
            ...
            (ae(n.target.files), (n.target.value = ""));
        },
        D = g.length >= re || oe;
      o.useEffect(() => {
        k(i);
      ...
      const pe = (n) => {
          if (n.key === "Enter") {
            if (n.nativeEvent.isComposing || n.shiftKey) return;
            n.preventDefault(), Z();
          }
        },
        ge = (n) => {
          n.key === "Enter" && !n.shiftKey && window.innerWidth > 768 && k("");
        };
            ...
            children: [
              ...
              e.jsxs(Be, {
                children: [
                  e.jsxs(je, {
                    variant: "caption2",
                    children: [c ? 0 : F.length, "/", l],
                  }),
                  e.jsxs(qe, {
                    backgroundColor: c ? u : p,
                    border: Q,
                    children: [
                      g &&
                        g.length > 0 &&
                      ...
                      e.jsx(We, {
                        onClick: Z,
                        backgroundColor: w ? C : x,
                        disabled: w || F.length === 0,
                        children: se
                          ? e.jsx(_e, {
                              isReminded: le,
                              children: e.jsx(q, {
...
`,
  ...
  border: ${(t) => {
    var r, l;
    return `${((r = t.border) == null ? void 0 : r.borderWidth) || "1px"} solid ${((l = t.border) == null ? void 0 : l.borderColor) || "#E0E0E0"}`;
  }};
  border-radius: ${(t) => {
    var r;
    return ((r = t.border) == null ? void 0 : r.borderRadius) || "12px";
  }};
  display: flex;
  flex-direction: column;
  justify-content: center;
...
M.__docgenInfo = {
  description: "",
  methods: [],
  displayName: "ChatSendField",
  props: {
    placeholder: {
      required: !1,
      tsType: { name: "string" },
      description: `입력 필드의 기본 플레이스홀더 텍스트
@default "메시지를 입력하세요..."`,
      defaultValue: { value: "'메시지를 입력하세요...'", computed: !1 },
    },
    disabledPlaceHolder: {
      required: !1,
      tsType: { name: "string" },
      description: `입력이 비활성화된 경우 표시될 플레이스홀더 텍스트
@default "텍스트를 입력할 수 없습니다."`,
      defaultValue: { value: "'텍스트를 입력할 수 없습니다.'", computed: !1 },
    },
    maxLength: {
      required: !1,
      tsType: { name: "number" },
      description: `입력 가능한 최대 문자 길이
@default 500`,
...
@example "#FFFFFF"`,
    ...
    textFieldDisabledBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `입력 필드가 비활성화되었을 때의 배경색
@example "#F4F4F4"`,
...
@example "#1F87FF"`,
    ...
    sendButtonDisabledBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 전송 버튼의 배경색
@example "#E0E0E0"`,
      defaultValue: { value: "'#E0E0E0'", computed: !1 },
    },
    sendButtonIconColor: {
      required: !1,
      tsType: { name: "string" },
      description: `전송 버튼 아이콘 색상
@example "#FFFFFF"`,
      defaultValue: { value: "'#FFFFFF'", computed: !1 },
    },
    sendButtonDisabledIconColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 전송 버튼 아이콘 색상
@example "#F4F4F4"`,
      defaultValue: { value: "'#F4F4F4'", computed: !1 },
    },
    imageButtonBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `이미지 업로드 버튼의 배경색
@example "#E0E0E0"`,
      defaultValue: { value: "'#E0E0E0'", computed: !1 },
    },
    imageButtonDisabledBackgroundColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 이미지 업로드 버튼의 배경색
@example "#E0E0E0"`,
      defaultValue: { value: "'#E0E0E0'", computed: !1 },
    },
    imageButtonIconColor: {
      required: !1,
      tsType: { name: "string" },
      description: `이미지 업로드 버튼 아이콘 색상
@example "#8D8D8D"`,
      defaultValue: { value: "'#8D8D8D'", computed: !1 },
    },
    imageButtonDisabledIconColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 이미지 업로드 버튼 아이콘 색상
@example "#F4F4F4"`,
      defaultValue: { value: "'#F4F4F4'", computed: !1 },
    },
    placeholderColor: {
...
@example "#1F87FF"`,
    ...
    disabledPlaceholderColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 플레이스홀더 텍스트 색상
@example "#C6C6C6"`,
...
@example "#262626"`,
    ...
    disabledTextColor: {
      required: !1,
      tsType: { name: "string" },
      description: `비활성화된 상태의 입력 텍스트 색상
@example "#C6C6C6"`,
      defaultValue: { value: "'#C6C6C6'", computed: !1 },
    },
    textFieldBorder: {
      required: !1,
      tsType: { name: "BorderProps" },
      description: "입력 필드의 테두리 스타일 (BorderProps 사용)",
      defaultValue: {
        value: `{
  ...
  borderRadius: '20px',
    ...
    onChange: {
      ...
      tsType: {
        ...
        signature: {
          arguments: [{ type: { name: "string" }, name: "newValue" }],
          return: { name: "void" },
        },
      },
      description: `입력값이 변경될 때 호출되는 콜백 함수
@param newValue 변경된 텍스트 값`,
    ...
    onSendMessage: {
      ...
      tsType: {
        name: "signature",
        type: "function",
        raw: "(message: string, images: string[]) => void",
        signature: {
          arguments: [
...
@param images 첨부된 이미지 목록`,
    ...
    onImageDelete: {
      ...
      tsType: {
        name: "signature",
        type: "function",
        raw: "(imageId: number) => void",
        signature: {
          arguments: [{ type: { name: "number" }, name: "imageId" }],
          return: { name: "void" },
        },
      },
      description: `이미지 삭제 시 호출되는 콜백 함수
@param imageId 삭제할 이미지의 ID (인덱스)`,
    ...
    onImageUpload: {
      ...
      tsType: {
        name: "signature",
        type: "function",
        raw: "(files: FileList) => void",
        signature: {
          arguments: [{ type: { name: "FileList" }, name: "files" }],
          return: { name: "void" },
        },
      },
      description: `이미지 업로드 시 호출되는 콜백 함수
@param files 업로드된 파일 리스트`,
    ...
    maxLengthOfImages: {
      required: !1,
      tsType: { name: "number" },
      description: `첨부할 수 있는 최대 이미지 개수
@default 5`,
...
@default false`,
    ...
    isReminded: {
      required: !1,
      tsType: { name: "boolean" },
      description: `이미 리마인드된 상태인지 여부
@default false`,
      defaultValue: { value: "false", computed: !1 },
    },
  },
};
const { useArgs: Y } = __STORYBOOK_MODULE_PREVIEW_API__,
  Xe = {
  ...
  I = {
    args: { sendDisabled: !1, imageDisabled: !1 },
    render: function (r) {
      const [{ value: l }, i] = Y(),
        m = (p) => {
          i({ ...r, value: p });
        };
      return e.jsx(M, { ...r, initialText: l, onChange: m });
    },
  },
  B = {
    args: {
    ...
    render: function (r) {
      const [{ value: l }, i] = Y(),
        ...
        p = (u) => {
          const x = A.filter((C, f) => f !== u);
          i({ ...r, images: x });
        };
      return e.jsx(M, { ...r, initialText: l, onChange: m, onImageDelete: p });
    },
  },
  j = {
    args: {
...
I.parameters = {
  ...
  render: function Render(args) {
    ...
    return <ChatSendField {...args} initialText={value} onChange={handleTextChange} />;
      ...
      ...(($ = (_ = I.parameters) == null ? void 0 : _.docs) == null
        ? void 0
        : $.source),
    },
  },
...
B.parameters = {
  ...
  render: function Render(args) {
    ...
    return <ChatSendField {...args} initialText={value} onChange={handleTextChange} onImageDelete={handleImageDelete} />;
      ...
      ...((O = (z = B.parameters) == null ? void 0 : z.docs) == null
        ? void 0
        : O.source),
    },
  },
...
j.parameters = {
  ...j.parameters,
  docs: {
    ...((U = j.parameters) == null ? void 0 : U.docs),
    source: {
      originalSource: `{
  args: {
    placeholder: '텍스트를 입력할 수 없습니다.',
    ...
    imageDisabled: true
      ...
      ...((X = (K = j.parameters) == null ? void 0 : K.docs) == null
        ? void 0
        : X.source),
    },
  },
};
const Ne = ["ChatDefault", "WithImages", "AllDisabled"];
export {
  j as AllDisabled,
  I as ChatDefault,
  B as WithImages,
