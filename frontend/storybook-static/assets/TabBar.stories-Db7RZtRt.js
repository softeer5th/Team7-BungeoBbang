...
import { d as u, T as $ } from "./Typography-BU4bE9sX.js";
const b = ({
    itemId: e,
    title: t,
    backgroundColor: o = "#FFFFFF",
    selectedBackroundColor: a = "#FFFFFF",
    textColor: s = "#C6C6C6",
...
const m = ({
    ...
    items: t,
    backgroundColor: o = "#FFFFFF",
    selectedItembackgroundColor: a = "#FFFFFF",
    indicatorColor: s = "#1F87FF",
    textColor: i = "#C6C6C6",
    selectedTextColor: d = "#1F87FF",
    onItemClick: F = () => {},
  }) => {
    var C;
    const [f, g] = l.useState(e || ((C = t[0]) == null ? void 0 : C.itemId)),
      h = t.findIndex((r) => r.itemId === f),
      [v, k] = l.useState(0),
      p = l.useRef(null);
    return (
      l.useEffect(() => {
      ...
      l.useEffect(() => {
        p.current && k(p.current.offsetWidth / t.length);
      }, [t.length]),
      n.jsxs(V, {
        ref: p,
        children: [
...
const { useArgs: j } = __STORYBOOK_MODULE_PREVIEW_API__,
  D = {
  ...
  c = {
    ...
    render: function (t) {
      const [{ value: o }, a] = j(),
        s = (i) => {
          a({ ...t, currentDestination: i });
        };
      return n.jsx(m, { ...t, currentDestination: o, onItemClick: s });
    },
  };
var I, T, y;
c.parameters = {
  ...
  render: function Render(args) {
    ...
    return <TabBar {...args} currentDestination={value} onItemClick={handleChange} />;
      ...
      ...((y = (T = c.parameters) == null ? void 0 : T.docs) == null
        ? void 0
        : y.source),
    },
  },
...
const R = ["Default"];
export { c as Default, R as __namedExportsOrder, D as default };
