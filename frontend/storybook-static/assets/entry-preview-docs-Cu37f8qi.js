...
import { r as Ge, R as ft } from "./index-Dkaqzkgy.js";
...
var Si = K({
  ...
  qi = K({
    "../../node_modules/escodegen/node_modules/source-map/source-map.js"(e) {
      (e.SourceMapGenerator = vn().SourceMapGenerator),
...
`,
        ...
        (q.regexp_eatControlLetter = function (e) {
          var t = e.current();
          return _n(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
        }),
        ...
        (q.regexp_eatUnicodePropertyName = function (e) {
          var t = 0;
          for (e.lastStringValue = ""; Sn((t = e.current())); )
...
function ku(e) {
  ...
  return t != null && (t.params != null || t.returns != null)
    ? me({
        name: "func",
        short: _u(t.params, t.returns),
        compact: null,
        full: vu(t.params, t.returns),
      })
    ...
    switch (t.name) {
      ...
      case "func": {
        let { short: r, full: n } = rt(t, e),
          s = r,
          o;
        return n && n.length < bu ? (s = n) : n && (o = Su(n)), ee(s, o);
      }
      default:
        return null;
    }
