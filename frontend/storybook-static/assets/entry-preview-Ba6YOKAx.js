...
import { _ as Be } from "./iframe-B8jR8wPv.js";
import { _ as ur, a as O, d as pr } from "./chunk-XP5HYGXS-D5tuasO7.js";
import { a as cr, r as se, R as pe } from "./index-Dkaqzkgy.js";
import { r as mr } from "./index-CV8h-g8d.js";
var _e = { exports: {} },
  V = {};
/**
 * @license React
  ...
  Kr = async () => {
    try {
      let { configure: d } = await Be(
        async () => {
          const { configure: l } = await import("./index-Dt18g86q.js").then(
            (n) => n.a,
          );
          return { configure: l };
        },
