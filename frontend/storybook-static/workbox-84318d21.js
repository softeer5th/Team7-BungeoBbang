define(["exports"], function (t) {
  ...
  class u {
    ...
    isResponseCacheable(t) {
      let e = !0;
      return (
        this.h && (e = this.h.includes(t.status)),
        this.u &&
          e &&
          (e = Object.keys(this.u).some((e) => t.headers.get(e) === this.u[e])),
        e
      );
    }
  }
  ...
  const l = {
    ...
    w = (t) =>
      [f.prefix, t, f.suffix].filter((t) => t && t.length > 0).join("-"),
    d = (t) => t || w(f.precache),
    p = (t) => t || w(f.runtime);
  function y(t, e) {
    const s = new URL(t);
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), {
                ...
                o = await t.keys(e, r);
              for (const e of o) if (i === y(e.url, s)) return t.match(e, n);
  ...
  class q {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        r = this.L(i, s, e);
      return [r, this._(r, i, s, e)];
    }
    async L(t, e, n) {
      let i;
      await t.runCallbacks("handlerWillStart", { event: n, request: e });
      try {
        if (((i = await this.C(e, t)), !i || "error" === i.type))
  ...
  class C {
    constructor({ precacheController: t }) {
      (this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
        const s =
          (null == e ? void 0 : e.cacheKey) || this.O.getCacheKeyForURL(t.url);
  ...
  class P {
    constructor({
      ...
      (this.k = new Map()),
        ...
        (this.p = new N({
          cacheName: d(t),
          plugins: [...e, new C({ precacheController: this })],
          fallbackToNetwork: s,
        })),
  ...
  (t.CacheableResponsePlugin = class {
    ...
    (t.NavigationRoute = class extends i {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        super((t) => this.D(t), t), (this.I = e), (this.F = s);
      }
      D({ url: t, request: e }) {
        if (e && "navigate" !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.F) if (t.test(s)) return !1;
        return !!this.I.some((t) => t.test(s));
      }
    }),
    (t.NetworkFirst = class extends q {
      constructor(t = {}) {
        super(t),
          ...
          (this.A = t.networkTimeoutSeconds || 0);
      }
      async C(t, e) {
        const n = [],
          i = [];
        ...
        const o = this.$({ timeoutId: r, request: t, logs: n, handler: e });
        i.push(o);
      ...
      async $({ timeoutId: t, request: e, logs: s, handler: n }) {
        let i, r;
        try {
    ...
    (t.createHandlerBoundToURL = function (t) {
      return T().createHandlerBoundToURL(t);
    }),
