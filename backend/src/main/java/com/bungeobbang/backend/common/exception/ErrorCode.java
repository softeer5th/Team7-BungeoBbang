...
public enum ErrorCode {
    ...
    AGENDA_NOT_STARTED(HttpStatus.BAD_REQUEST, "아직 진행 전인 답해요 안건입니다."),
    AGENDA_CLOSED(HttpStatus.BAD_REQUEST, "종료된 답해요 안건입니다."),
    AGENDA_DELETED(HttpStatus.BAD_REQUEST, "삭제된 답해요 안건입니다."),
