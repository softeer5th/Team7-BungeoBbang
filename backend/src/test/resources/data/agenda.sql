...
VALUES
    --upcoming
    (1, 1, '학사 일정 조정 논의', DATEADD(DAY, 5, CURRENT_DATE), DATEADD(DAY, 5, CURRENT_DATE), '학사 일정 조정 논의에 대한 논의.', false,
     334, 'ACADEMICS', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (1, 1, '기숙사 환경 개선', DATEADD(DAY, 10, CURRENT_DATE), DATEADD(DAY, 15, CURRENT_DATE), '기숙사 환경 개선에 대한 논의.', false, 304,
    ...
    (1, 1, '동아리 활동 지원', DATEADD(DAY, 3, CURRENT_DATE), DATEADD(DAY, 6, CURRENT_DATE), '동아리 활동 지원에 대한 논의.', false, 106,
    ...
    (1, 1, '강의실 환경 개선', DATEADD(DAY, -15, CURRENT_DATE), DATEADD(DAY, 1, CURRENT_DATE), '강의실 환경 개선에 대한 논의.', false, 142,
     'FACILITIES', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ...
    (1, 1, '기숙사 식당 메뉴 개선', DATEADD(DAY, -20, CURRENT_DATE), DATEADD(DAY, 0, CURRENT_DATE), '기숙사 식당 메뉴 개선에 대한 논의.',
     true, 189, 'FACILITIES', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    -- closed
